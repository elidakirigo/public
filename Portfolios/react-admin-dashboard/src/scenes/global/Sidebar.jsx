...
import HelpOutOutlinedIcon from '@mui/icons-material/HelpOutOutlined'
...
const Item = ({ title, to, icon, selected, setSelected }) => {
	...
	const colors = tokens(theme.palettte.mode)
		...
		<Box sx={{
			...
			<ProSideBar collapsed={isCollapsed}>
				<Menu iconShape="square">
					...
					{/* NEW : returning undefined as an option */}
					...
					{!isCollapsed && (
						<Box mb="25px">
							<Box display="flex" justifyContent="center" alignItems="center"><img alt="profile-user" width="100px" height="100px" src={`https://elidakirigo.github.io/public/responsive-mini-portfolio(html-css-js)/assets/img/perfil.jpg`} style={{ cursor: "pointer", borderRadius: "50%" }} /></Box>
					...
					<Box paddingLeft={isCollapsed ? undefined : "10%"}>
						...
						<Item title="Invoices Balances" to="/Invoices" icon={<RecieptOutlinedIcon />} selected={selected} setSelected={setSelected}></Item>
						...
						<Item title="FAQ page" to="/faq" icon={<HelpOutOutlinedIcon />} selected={selected} setSelected={setSelected}></Item>
